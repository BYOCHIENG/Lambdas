...
func HandleRequest(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	if err := validateFormData(data); err != nil {
		...
		if alertErr := sendAlertEmail(ctx, cfg, err, originalData); alertErr != nil {
...
func initSESClient(ctx context.Context, region string) (emailer.EmailSender, error) {
...
func sendAlertEmail(ctx context.Context, cfg config.Config, err error, data interface{}) error {
